    ...
    <div id="header-container" className="flex justify-between items-center p-4">
      ...
      <div id="icons-container" className="flex items-center space-x-4">
        <div id="notification-icon" className="relative p-3 bg-blue-100 rounded-2xl text-blue-500 cursor-pointer">
          <FaBell />
          <span id="notification-badge" className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-blue-500 text-white rounded-full px-1.5 py-0.5 text-[10px] border-2 border-white">
            50
          </span>
        </div>
        ...
        <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 border-gray-300">
          <span id="profile-text" className="text-gray-700">
            Hello, <b className="font-bold">Azizah Arshadini</b>
          </span>
          <img
            id="profile-avatar"
